...
const FLEET = {
  ...
  classics: [
    { image: '/assets/classic-mercedes-ponton-wedding-front.jpg', alt: 'Classic Mercedes collection', name: 'Classic Mercedes collection', desc: 'Vintage cars for weddings, events and productions.' },
    { image: '/assets/classic-mercedes-sedan-black-street.jpg', alt: 'Classic Mercedes-Benz sedan', name: 'The Stroke Eight', desc: 'One of the collection — see the full lineup on Classic Cars.' },
  ],
};
